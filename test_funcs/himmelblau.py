...
class Himmelblau:
    def __init__(self):
        ...
        self.x_optimum_1, self.y_optimum_1, self.z_optimum_1 = -2.805118, 3.131312, 0  # Global optimum 2
        self.x_optimum_2, self.y_optimum_2, self.z_optimum_2 = -3.779310, -3.283186, 0  # Global optimum 3
        self.x_optimum_3, self.y_optimum_3, self.z_optimum_3 = -3.584428, -1.848126, 0  # Global optimum 4
